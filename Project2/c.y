...
SECTION: S_DECLARATION | S_FUNCTION
...
DATA_TYPE: KW_UNSIGNED | LESSER_DATA_TYPE | KW_UNSIGNED LESSER_DATA_TYPE | KW_VOID | STRUCTURE

LESSER_DATA_TYPE: KW_CHAR | KW_SHORT | KW_INT | KW_LONG | KW_DOUBLE | KW_FLOAT
...
/* S_FUNCTION */
 /* function declaration consists of return type specification 
    ...
    and one for KW_VOID */
// S_FUNCTION: DATA_TYPE FUN_HEAD BLOCK | KW_VOID FUN_HEAD BLOCK
...
INSTRUCTION: ';' | FUN_CALL | FOR_INSTR | ASSIGNMENT ';' | INCR ';' | IF_INSTR | WHILE_INSTR | DO_WHILE
...
QUALIF: SUBSCRIPTS | '.' IDENT QUALIF
...
EXPR: NUMBER | IDENT QUALIF | EXPR '+' EXPR | EXPR '-' EXPR | EXPR '*' EXPR | EXPR '/' EXPR | EXPR NEG | '(' EXPR ')' | COND_EXPR
...
LOG_EXPR: EXPR LE EXPR | EXPR '<' EXPR | EXPR '>' EXPR
...
{
	int ret;
	printf( "Author: Mateusz Chmielewski 193661\n" );
